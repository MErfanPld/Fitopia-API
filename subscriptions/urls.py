...
urlpatterns = [
    ...
    path("subscriptions/<int:pk>/gyms/", views.SubscriptionGymsAPIView.as_view(), name="subscription-gyms"),
    path("subscriptions/me/gyms/",views.MyActiveSubscriptionGymsAPIView.as_view(), name="my-subscription-gyms"),
