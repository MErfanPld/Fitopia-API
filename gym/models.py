...
class Sport(models.Model):
    category = models.ForeignKey(
        SportCategory, on_delete=models.CASCADE, related_name="sports", verbose_name="دسته‌بندی"
    )
...
class GymFacility(models.Model):
    title = models.CharField(max_length=100, verbose_name="نام امکانات")
...
class Gym(models.Model):
    ...
    facilities = models.ManyToManyField(GymFacility, blank=True, related_name="gyms", verbose_name="امکانات")
    latitude = models.FloatField(verbose_name="عرض جغرافیایی")
    longitude = models.FloatField(verbose_name="طول جغرافیایی")
    cover_image = models.ImageField(upload_to=upload_gym_cover_image, blank=True, null=True, verbose_name="تصویر اصلی باشگاه")
    working_hours = models.CharField(max_length=255, blank=True, verbose_name="ساعات کاری")
    ...
    GENDER_CHOICES = [("women", "بانوان"), ("men", "آقایان"), ("both", "آقایان و بانوان")]
    gender = models.CharField(max_length=10, choices=GENDER_CHOICES, default="both", verbose_name="جنسیت باشگاه", help_text="women | men | both")
    is_open = models.BooleanField(default=True, verbose_name="باز است", help_text="وضعیت فعلی باز/بسته بودن باشگاه")
...
class GymPrice(models.Model):
    ...
    session_price = models.PositiveIntegerField(default=0, verbose_name="قیمت تک جلسه")
    monthly_price = models.PositiveIntegerField(verbose_name="قیمت ماهانه")
    quarterly_price = models.PositiveIntegerField(default=0, verbose_name="قیمت سه ماهه")
...
class GymImage(models.Model):
    gym = models.ForeignKey(Gym, on_delete=models.CASCADE, related_name="images", verbose_name="باشگاه")
...
class GymVideo(models.Model):
    gym = models.ForeignKey(Gym, on_delete=models.CASCADE, related_name="videos", verbose_name="باشگاه")
...
class GymBanner(models.Model):
    gym = models.ForeignKey(Gym, on_delete=models.CASCADE, related_name="banners", verbose_name="باشگاه")
...
class GymCoach(models.Model):
    gym = models.ForeignKey(Gym, on_delete=models.CASCADE, related_name="coaches", verbose_name="باشگاه")
    ...
    image = models.ImageField(upload_to="gyms/coaches/", verbose_name="تصویر مربی", null=True, blank=True)
...
class GymReview(models.Model):
    gym = models.ForeignKey(Gym, on_delete=models.CASCADE, related_name="reviews", verbose_name="باشگاه")
